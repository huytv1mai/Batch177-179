...
public partial class ProductManagermentBatch177Context : DbContext
{
    public ProductManagermentBatch177Context()
    {
    }

    public ProductManagermentBatch177Context(DbContextOptions<ProductManagermentBatch177Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<NewCategory> NewsCategories { get; set; }
